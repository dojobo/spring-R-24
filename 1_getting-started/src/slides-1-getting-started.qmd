...
-   There is no homework *per se*, but I suggest to practice applying what we learn to your own data between sessions. I also plan to share suggested reading for each session.

## Two exercise tracks

🅰⚕ biomedical data examples

🅱👥 social science and civic data examples

![Lesson format](images/lesson-format.svg){fig-alt="Lecture 1, followed by Exercise 1 (in two tracks), followed by Lecture 2, followed by Exercise 2 (in two tracks)" fig-align="center"}
