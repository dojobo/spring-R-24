...
-   How will we use our time?
    ...
    -   Practice with hands-on Exercises; work in couples/groups (recommended) or independently
...
-   string or character-based data
    ...
    -   may consist of plain text or specially encoded information (markup languages, tabular formats)
...
-   compressed data
    -   one of the above types with some bits removed
...
-   Tabular format -- quantitative, statistical methods
-   Document format (XML) -- qualitative methods
...
-   Measuring chlorophyll and phosphorus at multiple points in Lake Erie to understand algal bloom patterns; Bayesian network ([Rowland et al. 2019](https://doi.org/10.1021/acs.est.9b05326))
-   Characterizing how people perceive themselves in a mirror versus looking at their own body; Principal Components Analysis ([Jenkinson and Preston 2017](https://doi.org/10.1016/j.concog.2016.12.007))
-   Identifying patients at risk for paternal age-related schizophrenia; K-Means clustering ([Lee et al. 2011](https://doi.org/10.1016/j.schres.2011.02.006))
-   Modeling chemical properties of constituents in a mixture using molecular simulation; simulation and multiple linear regression ([Josephson et al. 2019](https://doi.org/10.1080/00268976.2019.1648898))
