...
```{r}
writeLines(readr::read_file("scripts/soln-1.2-a-1.R"))
```
...
```{r}
writeLines(readr::read_file("scripts/soln-1.2-a-2.R"))
```
...
```{r}
writeLines(readr::read_file("scripts/soln-1.2-a-3.R"))
```
...
```{r}
writeLines(readr::read_file("scripts/soln-1.2-a-4.R"))
```
...
```{r}
writeLines(readr::read_file("scripts/soln-1.2-a-5.R"))
```
...
```{r}
writeLines(readr::read_file("scripts/soln-1.2-a-6.R"))
```
