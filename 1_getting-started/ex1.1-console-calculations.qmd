...
```{r}
writeLines(readr::read_file("src/scripts/soln-1.1-a-1.R"))
```
...
```{r}
writeLines(readr::read_file("src/scripts/soln-1.1-a-2.R"))
```
...
```{r}
writeLines(readr::read_file("src/scripts/soln-1.1-a-3.R"))
```
